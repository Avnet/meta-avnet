...
# locations 0x9A to 0x9F and store as individual octets.
EEPROM_RAW_READ_STRING=$(i2cget -f -y ${BUS} ${SLAVE} 0x9A)
MAC_OCTET1=${EEPROM_RAW_READ_STRING#$HEX_PREFIX}

EEPROM_RAW_READ_STRING=$(i2cget -f -y ${BUS} ${SLAVE} 0x9B)
MAC_OCTET2=${EEPROM_RAW_READ_STRING#$HEX_PREFIX}

EEPROM_RAW_READ_STRING=$(i2cget -f -y ${BUS} ${SLAVE} 0x9C)
MAC_OCTET3=${EEPROM_RAW_READ_STRING#$HEX_PREFIX}

EEPROM_RAW_READ_STRING=$(i2cget -f -y ${BUS} ${SLAVE} 0x9D)
MAC_OCTET4=${EEPROM_RAW_READ_STRING#$HEX_PREFIX}

EEPROM_RAW_READ_STRING=$(i2cget -f -y ${BUS} ${SLAVE} 0x9E)
MAC_OCTET5=${EEPROM_RAW_READ_STRING#$HEX_PREFIX}

EEPROM_RAW_READ_STRING=$(i2cget -f -y ${BUS} ${SLAVE} 0x9F)
