...
YAML_COMPILER_FLAGS:append:k24 = "-DENABLE_MOD_ULTRA96 -DENABLE_SCHEDULER"
YAML_COMPILER_FLAGS:append:k24 = "${@bb.utils.contains('ULTRA96_VERSION', '2', ' -DULTRA96_VERSION=2', ' -DULTRA96_VERSION=1', d)}"
YAML_COMPILER_FLAGS:append:k24 = " -DBOARD_SHUTDOWN_PIN=2 -DBOARD_SHUTDOWN_PIN_STATE=0"
YAML_COMPILER_FLAGS:append:k24 = " -DK24_SOM"
